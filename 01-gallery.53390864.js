...
const markup = (0, _galleryItems.galleryItems).map((item)=>`<a class="gallery__item" href=${item.original}><img class="gallery__image" src=${item.preview} alt=${item.description}/></a>`).join("");
...
},{}]},["8EXaa","6XVkV"], "6XVkV", "parcelRequirec0c7")
